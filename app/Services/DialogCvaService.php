...
class DialogCvaService
{
    public static function new(): ClassVarianceAuthority
    {
        return ClassVarianceAuthority::new(
            [
                'transition ease-in-out [transition-behavior:allow-discrete] backdrop:bg-black/80 backdrop:duration-300 backdrop:opacity-0 backdrop:transition-[opacity,display,overlay] backdrop:[transition-behavior:allow-discrete] open:backdrop:opacity-100 [@starting-style]:open:backdrop:opacity-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2',
            ],
            [
                'variants' => [
                    'variant' => [
